...
public class DemoCollections {
    ...
    /** Returns a map (a.k.a dictionary) that tracks the count of all targets words in words. */
    ...
    public static void main(String[] args) {
        List<String> w  = getWords("words.txt");
        List<String> targets = new ArrayList<>();
        targets.add("abaculus");
        targets.add("abasedly");
